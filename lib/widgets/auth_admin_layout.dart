...
/// Clean, simple, and professional Web Admin/Owner Auth Layout.
///
/// Enterprise-grade design:
/// - Minimalist top bar with official Brahms branding & live portal status
/// - Warm, soft neutral canvas with ample whitespace
/// - Centered floating form card
/// - Discreet enterprise security and copyright footer
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFFD2B48C), width: 1.2),
                  ),
                  child: ClipOval(
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) =>
                          const Icon(Icons.restaurant, color: Color(0xFF8B4513), size: 18),
                    ),
                  ),
                ),
          ...
          Expanded(
            child: Stack(
              children: [
                // Very subtle warm radial gradient at the top of the canvas
                Positioned(
                  top: 0,
                  left: 0,
                  right: 0,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ConstrainedBox(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: const Color(0xFF2B1B12).withValues(alpha: 0.06),
                                    blurRadius: 24,
                          ...
                          // Discreet Enterprise Footer
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: const [
                              Icon(Icons.lock_outline_rounded, size: 13, color: Color(0xFF9E8B7E)),
                              SizedBox(width: 5),
                              Text(
